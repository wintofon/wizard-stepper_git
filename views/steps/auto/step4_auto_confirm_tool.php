...
/**
 * File: C:\xampp\htdocs\wizard-stepper_git\views\steps\auto\step4_auto_confirm_tool.php
 *
...
if ($DEBUG && function_exists('dbg')) dbg('🔧 step4_auto_confirm_tool.php iniciado');
