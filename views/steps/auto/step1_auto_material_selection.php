...
/**
 * File: C:\xampp\htdocs\wizard-stepper_git\views\steps\auto\step1_auto_material_selection.php
 *
 ...
 * • Avanza a step2_auto_strategy_selection.php
 */
...
if ($DEBUG && function_exists('dbg')) {
    dbg('🔧 step1_auto_material_selection.php iniciado');
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$err) {
        ...
        header('Location: ' . asset('views/steps/auto/step2_auto_strategy_selection.php'));
        exit;
    }
}
