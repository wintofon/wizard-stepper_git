 ...
 *    – Hacer fetch AJAX a get_tools_by_session.php y cargar dinámicamente las tarjetas.
 ...
 *   /ajax/get_tools_by_session.php → devuelve JSON de fresas compatibles.
 */
...
<body>
  ...
  (() => {
    ...
    /**
     * 1) Hacer fetch AJAX a get_tools_by_session.php para obtener JSON de fresas.
     */
    async function fetchTools() {
      try {
        const url = `${window.BASE_URL}/ajax/get_tools_by_session.php?material_id=${encodeURIComponent(materialId)}&strategy_id=${encodeURIComponent(strategyId)}`;
