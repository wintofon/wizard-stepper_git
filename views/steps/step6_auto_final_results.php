<?php
// File: C:\xampp\htdocs\wizard-stepper_git\views\steps\step6_auto_final_results.php
...
$step6JsRel      = file_exists($root . 'assets/js/step6_auto_results_chart.js')
    ? asset('assets/js/step6_auto_results_chart.js') : '';
...
<!--  🔻  ⬇︎  Añade esto JUSTO ANTES de cargar step6_auto_results_chart.js  ⬇︎  🔻 -->
<script>
  /* parámetros técnicos precalculados en PHP */
  window.step6Params = <?= $jsonParams ?>;

  /* token CSRF para que step6_auto_results_chart.js lo reenvíe al endpoint */
  window.step6Csrf   = '<?= $csrfToken ?>';
</script>

<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/chart.js/dist/chart.umd.min.js"></script>
<script src="<?= asset('assets/js/step6_auto_results_chart.js') ?>"></script>
<script>
