<?php
// File: C:\xampp\htdocs\wizard-stepper_git\views\steps\step6_auto_expert_result.php
...
$step6JsRel      = file_exists($root . 'assets/js/step6_auto_expert_result.js')
    ? asset('assets/js/step6_auto_expert_result.js') : '';
...
<head>
  ...
  <link rel="stylesheet" href="<?= asset('assets/css/pages/_step6_auto_expert_result.css') ?>">
...
<!--  🔻  ⬇︎  Añade esto JUSTO ANTES de cargar step6_auto_expert_result.js  ⬇︎  🔻 -->
<script>
  /* parámetros técnicos precalculados en PHP */
  window.step6Params = <?= $jsonParams ?>;

  /* token CSRF para que step6_auto_expert_result.js lo reenvíe al endpoint */
  window.step6Csrf   = '<?= $csrfToken ?>';
</script>

<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/chart.js/dist/chart.umd.min.js"></script>
<script src="<?= asset('assets/js/step6_auto_expert_result.js') ?>"></script>
<script>
