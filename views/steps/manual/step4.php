 ...
 * Descripción: Selección de material y espesor.
 * 
 * ✅ Único cambio respecto al original:
 *     • Se añade clase `.mat-label` (color celeste corporativo ≈ h5)
 *       y se aplica a: “Buscar material…”, el subtítulo “— o elegí por
 *       categoría —”, los encabezados “Categoría”, “Material” y “Espesor”.
 */

declare(strict_types=1);

/* --------------------------------------------------------------------- */
/* Pequeño helper para errores AJAX/HTML                                 */
/* --------------------------------------------------------------------- */
...
/* --------------------------------------------------------------------- */
/* A) Cabeceras de seguridad / cache                                     */
/* --------------------------------------------------------------------- */
...
/* --------------------------------------------------------------------- */
/* H) Materiales compatibles (solo categorías “Madera…”)                 */
/* --------------------------------------------------------------------- */
...
?>
<style>
.mat-label{color:var(--mat-accent);font-weight:600;font-size:1.25rem;margin-bottom:.35rem}
...
<form id="formMat" method="post" novalidate>
  ...
  <div id="catRow" class="d-flex flex-wrap mb-3">
    <?php foreach($parents as $pid=>$name):?>
      <button type="button" class="btn btn-outline-primary btn-cat" data-pid="<?=$pid?>"><?php echo htmlspecialchars($name);?></button>
    <?php endforeach;?>
  </div>

  <!-- Materiales ----------------------------------------------------- -->
  <div id="matBox" class="mb-3" 스타일="display:none">
