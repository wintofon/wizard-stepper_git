...
<body>
    ...
    <main class="container py-4" data-debug="step1">
      ...
      <div class="row">
        ...
        <main class="col-md-9">
          ...
          <!-- Contenedor de tarjetas que se irán cargando dinámicamente -->
          <div id="tool-list" class="row g-3"></div>
          <!-- Sentinel usado por IntersectionObserver para detectar el fondo -->
          <div id="sentinel"></div>
        </main>
      </div>
  ...
  <!-- Módulo para cargar las fresas a medida que se hace scroll -->
  <script type="module" src="/wizard-stepper_git/assets/js/step1_lazy.js"></script>

  <!-- Helper global dbg() para imprimir en consola y <pre id="debug"> -->
  <script>
    window.dbg = (...m) => {
      console.log('[DBG]', ...m);
