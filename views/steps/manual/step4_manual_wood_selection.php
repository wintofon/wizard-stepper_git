...
/**
 * File: views/steps/manual/step4_manual_wood_selection.php
...
if ($DEBUG && function_exists('dbg')) dbg('🔧 step4_manual_wood_selection.php iniciado');
...
if (empty($_SESSION['tool_id']) || empty($_SESSION['tool_table'])) {
    header('Location:' . asset('views/steps/auto/step2_auto_strategy_selection.php')); exit;
}
...
if ($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    if(!$err){
        ...
        header('Location:' . asset('views/steps/step5_auto_router_config.php')); exit;
    }
}
?>
