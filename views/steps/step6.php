...
<div class="content-main">
  ...
  <div class="container-fluid py-4 step6">
    ...
    <div class="cards-grid mb-4"><!-- grilla -->
  <!--──────────── Resultados ────────────-->
  <div class="area-results"><!-- ítem → SIN .col-* -->
    <div class="card h-100 shadow-sm">
      <div class="card-header text-center p-3">
  ...
  <!--──────────── Radar Chart ────────────-->
  <div class="area-radar"><!-- ítem → SIN .col-* -->
    <div class="card h-100 shadow-sm">
      <div class="card-header text-center p-3">
...
<!-- ===============================================================
     BLOQUE · Especificaciones  +  Configuración  +  Notas
================================================================ -->
<div class="cards-grid mb-4"><!-- grilla -->
  <!--──────────── Especificaciones ────────────-->
  <div class="area-specs">
<?= /* —— Pega aquí la tarjeta “Especificaciones Técnicas” sin cambios —— */ '' ?>
  </div>

  <!--──────────── Configuración ────────────-->
  <div class="area-config">
<?= /* —— Pega aquí la tarjeta “Configuración de Usuario” sin cambios —— */ '' ?>
  </div>

  <!--──────────── Notas ────────────-->
  <div class="area-notes">
<?= /* —— Pega aquí la tarjeta “Notas Adicionales” sin cambios —— */ '' ?>
  </div>
</div><!-- /.cards-grid -->
