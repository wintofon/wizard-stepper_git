...
<div class="mb-3 d-flex justify-content-between">
  ...
  <a href="transmission_form.php" class="btn btn-success">➕ Nueva Transmisión</a>
</div>
  ...
  <tbody>
    <?php foreach ($transmissions as $t): ?>
      <tr>
        ...
        <td>
          <a href="transmission_form.php?id=<?= $t['id'] ?>" class="btn btn-sm btn-secondary">Editar</a>
          <a href="transmission_delete.php?id=<?= $t['id'] ?>" class="btn btn-sm btn-danger"
