    ...
    <tbody>
        <?php foreach ($categories as $c): ?>
            <tr>
                ...
                <td>
                    <a href="edit.php?id=<?= $c['category_id'] ?>" class="btn btn-sm btn-secondary">Editar</a>
                    <a href="delete.php?id=<?= $c['category_id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Estás seguro que querés eliminar esta categoría?');">Eliminar</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
