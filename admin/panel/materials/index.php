    ...
    <tbody>
        <?php foreach ($materials as $mat): ?>
            <tr>
                ...
                <td>
                    <a href="edit.php?id=<?= $mat['material_id'] ?>" class="btn btn-sm btn-secondary">Editar</a>
                    <a href="delete.php?id=<?= $mat['material_id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Estás seguro de eliminar este material?');">Eliminar</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
