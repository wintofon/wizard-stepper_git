...
<div class="mb-3 d-flex justify-content-between">
  ...
  <a href="strategy_form.php" class="btn btn-success">➕ Nueva Estrategia</a>
</div>
  ...
  <tbody>
    <?php foreach ($strategies as $s): ?>
      <tr>
        ...
        <td>
          <a href="strategy_edit.php?id=<?= $s['strategy_id'] ?>" class="btn btn-sm btn-secondary">
            Editar
          </a>
          <a href="strategy_delete.php?id=<?= $s['strategy_id'] ?>" 
